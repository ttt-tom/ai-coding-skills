...
新项目可说：
> 阅读 skills/efficient-code-maintenance/SKILL.md，按我的需求立项，使用 templates 建立维护入口；不要覆盖已有文件，不要自动部署。
...
默认排除 static、private_media、vendor、node_modules 和隐藏目录。非 Python 使用 rg/LSP；不假装支持其 AST。
